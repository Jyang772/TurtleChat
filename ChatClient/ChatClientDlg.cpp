...
void CChatClientDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_IP_ADDRESS, m_sIPAddress);
	//}}AFX_DATA_MAP
}
...
void CChatClientDlg::OnSend() 
{
	...
	GetDlgItem(IDC_MSG)->SetWindowTextA("");     //Clear edit box when message sent
}
...
void CChatClientDlg::AddMsg(userinfo *udata)
{
	...
	sDisplay.Format("%s : %s",udata->cUserName,udata->csMsg);
